...
void usage() {
    cerr << "Usage: ./test audio.dat strategy" << "\n";
    cerr << "strategy is one of dt-0.9, dt-1.0, dt-2.0, lr-2.0, lr-2.1" << "\n";
}
